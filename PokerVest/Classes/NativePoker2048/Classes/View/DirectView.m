...
//  Poker2048
//
//  Created by pokerVest2048 on 16/3/22.
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.bigView = [[UIView alloc] initWithFrame:CGRectMake(30, 70, kScreenWidth-30*2, kScreenHeight-70*2)];
        ...
        // 添加指引图片
        CGFloat upperImageWidth = self.bigView.width-30*2;
        CGFloat upperImageHeight = self.bigView.width-30*2;
        UIImageView *upperImageView = [[UIImageView alloc] initWithFrame:CGRectMake(30, 0, upperImageWidth, upperImageWidth)];
        upperImageView.image = [UIImage imageNamed:@"swipe.png"];
        [_bigView addSubview:upperImageView];
        currentTop += upperImageHeight;
        
        CGFloat downImageWidth = upperImageWidth*0.8;
        UIImageView *downImageView = [[UIImageView alloc] initWithFrame:CGRectMake((self.bigView.width - downImageWidth)*0.5, upperImageWidth, downImageWidth, downImageWidth)];
        downImageView.image = [UIImage imageNamed:@"direct.png"];
        [_bigView addSubview:downImageView];
        currentTop = downImageWidth + upperImageHeight + 16;
        ...
        UIButton *startGameBtn = [[UIButton alloc] initWithFrame:CGRectMake((self.bigView.width - startGameBtnWidth)/2.0f, currentTop, startGameBtnWidth, startGameBtnHeight)];
