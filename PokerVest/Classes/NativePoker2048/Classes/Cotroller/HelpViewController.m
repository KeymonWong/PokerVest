...
- (void)setupBoard
{
    ...
    [returnBtn setImage:[UIImage imageNamed:@"home"] forState:UIControlStateNormal];
    [returnBtn setSize:CGSizeMake(returnBtnHeight, returnBtnHeight)];
    returnBtn.x = winSize.width/2.0f-returnBtnHeight/2.0f;
    returnBtn.y = currentTop;
