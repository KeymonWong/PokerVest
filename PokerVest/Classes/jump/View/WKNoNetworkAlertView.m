...
- (void)createSubViews{
    noView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 100)];
    [noView setBackgroundColor:[UIColor clearColor]];
    [self addSubview:noView];
    
    noNetworkAletIcon = [[UIImageView alloc] initWithFrame:CGRectMake((kScreenWidth - 42)*0.5, 0, 42, 42)];
    ...
    noNetworkAlertLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, CGRectGetMaxY(noNetworkAletIcon.frame)+15, kScreenWidth-10, 20)];
...
- (void)reloadCellular{
    ...
    cellularData.cellularDataRestrictionDidUpdateNotifier = ^(CTCellularDataRestrictedState state) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            CGRect frame = [string boundingRectWithSize:CGSizeMake(kScreenWidth - 10, NSIntegerMax) options:NSStringDrawingUsesLineFragmentOrigin context:nil];
            noNetworkAlertLabel.frame = CGRectMake(5, CGRectGetMaxY(noNetworkAletIcon.frame)+15, kScreenWidth-10, frame.size.height);
            
            noView.frame  = CGRectMake(0, 0, kScreenWidth, CGRectGetMaxY(noNetworkAlertLabel.frame));
...
- (void)layoutSubviews{
    ...
    noNetworkAletIcon.frame = CGRectMake((kScreenWidth - 42)*0.5, 0, 42, 42);
    noNetworkAlertLabel.frame = CGRectMake(5, CGRectGetMaxY(noNetworkAletIcon.frame)+15, kScreenWidth-10, noNetworkAlertLabel.frame.size.height);
    noView.frame  = CGRectMake(0, 0, kScreenWidth, CGRectGetMaxY(noNetworkAlertLabel.frame));
