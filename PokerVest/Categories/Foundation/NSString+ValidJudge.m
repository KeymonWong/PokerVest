//
//  NSString+ValidJudge.m
//  RainbowBridge
//
//  Created by FarTeen on 7/31/14.
//  Copyright (c) 2014 cmri. All rights reserved.
//

#import "NSString+ValidJudge.h"

@implementation NSString (ValidJudge)

#pragma mark 判斷台灣地區手機號是否正確
- (BOOL)isValidMobileForTaiwan {
...
- (BOOL)isValidMobile {
    ...
    if (self.length != 11) { ///< 手机号11位
        return NO;
    }
    
    NSString *MOBILE = @"[1][3456789]\\d{9}"; ///< 校验手机号前2位
...
- (BOOL)judgeTelecomOperatorWithMobile:(NSString *)mobileNum {
    /*
