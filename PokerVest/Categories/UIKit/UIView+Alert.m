...
- (void)showAlertWithTitle:(NSString *)title message:(NSString *)message confirmHandler:(void(^)(UIAlertAction *confirmAction))handler {
    [self showAlertWithTitle:title message:message confirmTitle:@"确认" confirmHandler:handler];
}
             ...
             cancelHandler:(void(^)(UIAlertAction *cancelAction))cancelHandler
{
    ...
    UIAlertAction *confirmlAction = [UIAlertAction actionWithTitle:confirmTitle style:UIAlertActionStyleDefault handler:confirmHandler];
...
- (void)showAlertWithTitle:(NSString *)title
            ...
            confirmHandler:(void(^)(UIAlertAction *confirmAction))confirmHandler
             cancelHandler:(void(^)(UIAlertAction *cancelAction))cancelHandler
{
    [self.view showAlertWithTitle:title
                          message:message
