...
#define kAppReviewOnAppStore ([NSString stringWithFormat:@"itms-apps://itunes.apple.com/cn/app/id%@?mt=8&action=write-review", kOnItunesConnectAppID])

//@"itms-apps://itunes.apple.com/cn/app/id%@?mt=8&action=write-review"

//详情页
//#define kAppDetailOnAppStore @"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id="
#define kAppDetailOnAppStore ([NSString stringWithFormat:@"itms-apps://itunes.apple.com/cn/app/id%@?mt=8", kOnItunesConnectAppID])
...
#define PATH_OF_LIBRARY   [NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES) lastObject]
...
#define kTopY (kStatusBarHeight + kNavBarHeight)
#define kBottomY (kDevice_Is_iPhoneX ? 34. : 0.)
...
#define kRatioY6 (kScreenHeight == 812.0 ? 667.0/667.0 : kScreenHeight/667.0)
...
#define adaptScrollViewInsetNever(controller,view) if(@available(iOS 11.0, *)) {view.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentNever;} else if([controller isKindOfClass:[UIViewController class]]) {controller.automaticallyAdjustsScrollViewInsets = false;}

///------ iOS 11 适配安全域
#define  adjustScrollViewInsetsForiOS11(scrollView)\
do {\
